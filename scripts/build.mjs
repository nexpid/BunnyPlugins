...
const mdNote = `<!--
  ...
  * https://github.com/nexpid/RevengePlugins/edit/main/scripts/build.mjs
-->`;
...
> **Note**
> This is just a simple landing page for **${manifest.name}**. The proper way to load this plugin is to go in Revenge's settings, going to Plugins, tapping the plus icon and pasting the plugin link\n`,
  );
