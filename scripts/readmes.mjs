...
// a proper proxy for Revenge wasn't implemented yet, so I'll link to the raw plugin
...
const links = {
  ...
  oldProxied:
    "https://vd-plugins.github.io/proxy/gabe616.github.io/RevengePlugins/",
  unproxied: "https://vendetta.nexpid.xyz/",
  code: `https://github.com/nexpid/RevengePlugins/tree/main/plugins/`,
  external: {
...
<div align="center">
  ${makeHref(
    "https://github.com/nexpid/RevengePlugins/stargazers",
    `<img alt="GitHub stars" src="https://img.shields.io/github/stars/nexpid/RevengePlugins?style=for-the-badge&color=${shieldColors.ghstars}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghstars}">`,
    1,
  )}
  ${makeHref(
    "https://github.com/nexpid/RevengePlugins/issues",
    `<img alt="GitHub issues" src="https://img.shields.io/github/issues/nexpid/RevengePlugins?style=for-the-badge&color=${shieldColors.ghissues}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghissues}">`,
    1,
  )}
  ${makeHref(
    "https://github.com/nexpid/RevengePlugins/pulls",
    `<img alt="GitHub pull requests" src="https://img.shields.io/github/issues-pr/nexpid/RevengePlugins?style=for-the-badge&color=${shieldColors.ghpullreqs}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghpullreqs}">`,
    1,
  )}
  ${makeHref(
    "https://discord.gg/ddcQf3s2Uq",
    `<img alt="Discord members" src="https://img.shields.io/discord/1205207689832038522?style=for-the-badge&color=${shieldColors.discord}&labelColor=${shieldLabelColor}&logo=${shieldLogos.discord}">`,
    1,
  )}
</div>
<br/>
