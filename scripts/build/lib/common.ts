...
export const makeMdNote = (file: string, flavor: keyof typeof mdNoteFlavors) => `${mdNoteFlavors[flavor][0]}
    * This file was autogenerated, do not modify it directly
    * https://github.com/nexpid/BunnyPlugins/tree/${branch}/${file}
${mdNoteFlavors[flavor][1]}`;

export const branch: string = execSync("git branch --show-current").toString().trim();
