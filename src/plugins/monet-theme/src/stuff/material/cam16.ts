...
export class Cam16 {
    ...
    static fromIntInViewingConditions(
        ...
        const rAF = Math.pow(
            (viewingConditions.fl * Math.abs(rD)) / 100.0,
            0.42,
        );
        const gAF = Math.pow(
            (viewingConditions.fl * Math.abs(gD)) / 100.0,
            0.42,
        );
        const bAF = Math.pow(
            (viewingConditions.fl * Math.abs(bD)) / 100.0,
            0.42,
        );
        ...
        const eHue =
            0.25 * (Math.cos((huePrime * Math.PI) / 180.0 + 2.0) + 3.8);
        const p1 =
            (50000.0 / 13.0) *
            eHue *
