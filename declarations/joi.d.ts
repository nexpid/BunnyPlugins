...
declare module "joi" {
    ...
    declare namespace Joi {
        ...
        interface Base64Options
            extends Pick<DataUriOptions, "paddingRequired"> {
            /**
        ...
        type IsUnion<T, U extends T = T> = T extends unknown
            ? [U] extends [T]
                ...
                : true
            : false;
        type IsNonPrimitiveSubsetUnion<T> =
        ...
        interface FunctionSchema<TSchema = Function>
        ...
        interface ExtensionTerm {
            ...
            manifest?: Record<
                string,
                "schema" | "single" | ExtensionTermManifest
            >;
        }
        interface Extension {
            type: string | RegExp;
