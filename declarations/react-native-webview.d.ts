...
declare module "react-native-webview" {
    ...
    declare type WebViewProgressEvent =
        NativeSyntheticEvent<WebViewNativeProgressEvent$1>;
    declare type WebViewNavigationEvent$1 =
        NativeSyntheticEvent<WebViewNavigation>;
    declare type ShouldStartLoadRequestEvent$1 =
    ...
    declare type WebViewTerminatedEvent =
        NativeSyntheticEvent<WebViewNativeEvent$1>;
    declare type WebViewHttpErrorEvent$1 =
        NativeSyntheticEvent<WebViewHttpError>;
    declare type WebViewRenderProcessGoneEvent$1 =
        NativeSyntheticEvent<WebViewRenderProcessGoneDetail>;
    declare type WebViewOpenWindowEvent$1 =
        NativeSyntheticEvent<WebViewOpenWindow>;
    ...
    declare type OnShouldStartLoadWithRequest = (
    ...
    interface CommonNativeWebViewProps extends ViewProps {
        ...
        onShouldStartLoadWithRequest: (
            event: ShouldStartLoadRequestEvent$1,
        ) => void;
        showsHorizontalScrollIndicator?: boolean;
        showsVerticalScrollIndicator?: boolean;
        source: any;
    ...
    declare type ContentInsetAdjustmentBehavior =
        | "automatic"
        | "scrollableAxes"
        | "never"
        | "always";
    declare type MediaCapturePermissionGrantType =
        | "grantIfSameHostElsePrompt"
        | "grantIfSameHostElseDeny"
        | "deny"
        | "grant"
    ...
    interface WebViewSharedProps extends ViewProps {
         ...
         */
        onLoadEnd?: (
            event: WebViewNavigationEvent$1 | WebViewErrorEvent$1,
        ) => void;
        /**
    ...
    export { WebView as default, WebViewMessageEvent$1 as WebViewMessageEvent };
