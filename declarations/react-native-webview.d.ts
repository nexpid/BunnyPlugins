...
declare module "react-native-webview" {
    ...
    import { HostComponent, NativeMethodsMixin, NativeScrollEvent, NativeSyntheticEvent, StyleProp, ViewProps, ViewStyle } from 'react-native';
    import { DirectEventHandler, Double, Int32, WithDefault } from 'react-native/Libraries/Types/CodegenTypes';
    
    declare type WebViewNativeEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare type WebViewCustomMenuSelectionEvent = Readonly<{
    	label: string;
    	key: string;
    	selectedText: string;
    }>;
    declare type WebViewMessageEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare type WebViewOpenWindowEvent = Readonly<{
    	targetUrl: string;
    }>;
    declare type WebViewHttpErrorEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare type WebViewErrorEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare type WebViewNativeProgressEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare type WebViewNavigationEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare type ShouldStartLoadRequestEvent = Readonly<{
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    declare class NativeWebViewMacOS extends NativeWebViewMacOSBase {
    }
    interface ContentInsetProp {
    	top?: number;
    	left?: number;
    	bottom?: number;
    	right?: number;
    }
    interface WebViewNativeEvent$1 {
    	url: string;
    	loading: boolean;
    	title: string;
    	canGoBack: boolean;
    ...
    interface WebViewNativeProgressEvent$1 extends WebViewNativeEvent$1 {
    	progress: number;
    }
    export interface WebViewNavigation extends WebViewNativeEvent$1 {
    	navigationType: "click" | "formsubmit" | "backforward" | "reload" | "formresubmit" | "other";
    	mainDocumentURL?: string;
    }
    ...
    declare type DecelerationRateConstant = "normal" | "fast";
    interface WebViewMessage extends WebViewNativeEvent$1 {
    	data: string;
    }
    interface WebViewError extends WebViewNativeEvent$1 {
    	/**
    ...
    interface WebViewHttpError extends WebViewNativeEvent$1 {
    	description: string;
    	statusCode: number;
    }
    ...
    interface WebViewOpenWindow {
    	targetUrl: string;
    }
    declare type WebViewEvent = NativeSyntheticEvent<WebViewNativeEvent$1>;
    declare type WebViewProgressEvent = NativeSyntheticEvent<WebViewNativeProgressEvent$1>;
    declare type WebViewNavigationEvent$1 = NativeSyntheticEvent<WebViewNavigation>;
    declare type ShouldStartLoadRequestEvent$1 = NativeSyntheticEvent<ShouldStartLoadRequest>;
    declare type FileDownloadEvent = NativeSyntheticEvent<FileDownload>;
    declare type WebViewMessageEvent$1 = NativeSyntheticEvent<WebViewMessage>;
    declare type WebViewErrorEvent$1 = NativeSyntheticEvent<WebViewError>;
    declare type WebViewTerminatedEvent = NativeSyntheticEvent<WebViewNativeEvent$1>;
    declare type WebViewHttpErrorEvent$1 = NativeSyntheticEvent<WebViewHttpError>;
    declare type WebViewRenderProcessGoneEvent$1 = NativeSyntheticEvent<WebViewRenderProcessGoneDetail>;
    declare type WebViewOpenWindowEvent$1 = NativeSyntheticEvent<WebViewOpenWindow>;
    declare type WebViewScrollEvent = NativeSyntheticEvent<NativeScrollEvent>;
    declare type DataDetectorTypes = "phoneNumber" | "link" | "address" | "calendarEvent" | "trackingNumber" | "flightNumber" | "lookupSuggestion" | "none" | "all";
    declare type OverScrollModeType = "always" | "content" | "never";
    declare type CacheMode = "LOAD_DEFAULT" | "LOAD_CACHE_ONLY" | "LOAD_CACHE_ELSE_NETWORK" | "LOAD_NO_CACHE";
    declare type AndroidLayerType = "none" | "software" | "hardware";
    ...
    interface WebViewCustomMenuItems {
    	/**
    ...
    declare type SuppressMenuItem = "cut" | "copy" | "paste" | "replace" | "bold" | "italic" | "underline" | "select" | "selectAll" | "translate" | "lookup" | "share";
    declare type WebViewSource = WebViewSourceUri | WebViewSourceHtml;
    interface ViewManager {
    	shouldStartLoadWithLockIdentifier: Function;
    }
    interface WebViewNativeConfig {
    	/**
    	 * The native component used to render the WebView.
    	 */
    	component?: typeof NativeWebViewMacOS | typeof _default;
    	/**
    ...
    declare type OnShouldStartLoadWithRequest = (event: ShouldStartLoadRequest) => boolean;
    ...
    interface CommonNativeWebViewProps extends ViewProps {
    	cacheEnabled?: boolean;
    	incognito?: boolean;
    	injectedJavaScript?: string;
    	injectedJavaScriptBeforeContentLoaded?: string;
    	...
    	onLoadingError: (event: WebViewErrorEvent$1) => void;
    	onLoadingFinish: (event: WebViewNavigationEvent$1) => void;
    	onLoadingProgress: (event: WebViewProgressEvent) => void;
    	onLoadingStart: (event: WebViewNavigationEvent$1) => void;
    	onHttpError: (event: WebViewHttpErrorEvent$1) => void;
    	onMessage: (event: WebViewMessageEvent$1) => void;
    	onShouldStartLoadWithRequest: (event: ShouldStartLoadRequestEvent$1) => void;
    	showsHorizontalScrollIndicator?: boolean;
    	showsVerticalScrollIndicator?: boolean;
    	source: any;
    	userAgent?: string;
    ...
    declare type ContentInsetAdjustmentBehavior = "automatic" | "scrollableAxes" | "never" | "always";
    declare type MediaCapturePermissionGrantType = "grantIfSameHostElsePrompt" | "grantIfSameHostElseDeny" | "deny" | "grant" | "prompt";
    declare type ContentMode = "recommended" | "mobile" | "desktop";
    interface MacOSNativeWebViewProps extends CommonNativeWebViewProps {
    	allowingReadAccessToURL?: string;
    	allowFileAccessFromFileURLs?: boolean;
    	allowUniversalAccessFromFileURLs?: boolean;
    	allowsBackForwardNavigationGestures?: boolean;
    ...
    interface WindowsWebViewProps extends WebViewSharedProps {
    	/**
    	 ...
    	 * @platform windows
    	 */
    	onOpenWindow?: (event: WebViewOpenWindowEvent$1) => void;
    	/**
    	 ...
    	 * @platform windows
    	 */
    	onSourceChanged?: (event: WebViewNavigationEvent$1) => void;
    }
    interface IOSWebViewProps extends WebViewSharedProps {
    	/**
    ...
    interface AndroidWebViewProps extends WebViewSharedProps {
    	 ...
    	 */
    	onRenderProcessGone?: (event: WebViewRenderProcessGoneEvent$1) => void;
    	/**
    	 * Function that is invoked when the `WebView` should open a new window.
    	 *
    	 * This happens when the JS calls `window.open('http://someurl', '_blank')`
    ...
    interface WebViewSharedProps extends ViewProps {
    	 ...
    	 */
    	onScroll?: ComponentProps<typeof _default>["onScroll"];
    	/**
    	 * Function that is invoked when the `WebView` has finished loading.
    	 */
    	onLoad?: (event: WebViewNavigationEvent$1) => void;
    	/**
    	 * Function that is invoked when the `WebView` load succeeds or fails.
    	 */
    	onLoadEnd?: (event: WebViewNavigationEvent$1 | WebViewErrorEvent$1) => void;
    	/**
    	 * Function that is invoked when the `WebView` starts loading.
    	 */
    	onLoadStart?: (event: WebViewNavigationEvent$1) => void;
    	/**
    	 * Function that is invoked when the `WebView` load fails.
    	 */
    	onError?: (event: WebViewErrorEvent$1) => void;
    	/**
    ...
    export declare class WebView<P = {}> extends Component<WebViewProps & P> {
    	/**
    ...
    export {
    	WebView as default,
    	WebViewMessageEvent$1 as WebViewMessageEvent,
    };
